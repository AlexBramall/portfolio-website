...
export const Hero = ({ onNavigate }: HeroProps) => {
  return (
    <section
      id="home"
      className="min-h-screen flex flex-col items-center justify-center bg-white pt-16 px-4 sm:px-6 md:px-12"
    >
      <div className="text-center flex flex-col items-center">
        ...
        <p className="text-body font-normal text-light-muted max-w-[480px] mb-12 leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-8 py-3.5 bg-transparent text-dark-gray border border-button-border rounded-full text-label font-medium hover:border-muted-text hover:text-black transition-all duration-200"
          >
            Get In Touch
